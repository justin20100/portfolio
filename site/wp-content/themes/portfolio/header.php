...
<header class="header">
    <nav class="header__nav nav">
        ...
        <ul class="nav__container nav__flex">
            ...
            <li class="nav__item item_2">Contact</li>
        </ul>
    </nav>
